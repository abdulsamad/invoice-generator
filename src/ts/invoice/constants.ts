...
export const COMPANY_CONTACTS = process.env.COMPANY_CONTACTS as string;
export const COMPANY_INVOICE_DISCLAIMER = process.env.COMPANY_INVOICE_DISCLAIMER as string;
